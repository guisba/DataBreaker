...
GENERATED_FIELDS = {"Now", "NewGUID", "NewUUID", "FileSequence", "ProcessingTime"}
STRUCTURAL_FIELDS = {
...
def _explanation(raw_name: str, short: str, group: str, unknown: bool) -> str:
    if short in GENERATED_FIELDS:
        return (
            "Value generated by ExifTool at scan time. It is shown for completeness "
            "but is not embedded source-file metadata."
        )
    if short in FILESYSTEM_FIELDS:
        return (
